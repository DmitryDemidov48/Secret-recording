...
const Home = () => {
    return (
        <Container>
            ...
            <Description>
                Secret recording- это приложение, которое позволяет вам шифровать тексты с помощью различных методов шифрования. Вы можете выбрать нужный метод шифрования, ввести текст и увидеть его зашифрованную версию.
            </Description>
        </Container>
    );
};
